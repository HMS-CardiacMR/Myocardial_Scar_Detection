...
from Architectures.SOTA.Architecture_CNN_LSTM import cnn_3d_batchnorm_LSTM
...
model = cnn_3d_batchnorm_LSTM(input_shape)
...
print(x_train.shape)
x_train = x_train.reshape(x_train.shape[0], nb_frames,x_dim, y_dim, 1)
...
x_validation = x_validation.reshape(x_validation.shape[0], nb_frames,x_dim, y_dim, 1)
